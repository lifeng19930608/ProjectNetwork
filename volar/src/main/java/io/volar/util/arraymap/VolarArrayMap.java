 ...
 * consider using {@link VolarSimpleArrayMap} instead.</p>
 * <p>
 ...
 */
public class VolarArrayMap<K, V> extends VolarSimpleArrayMap<K, V> implements Map<K, V> {
    MapCollections<K, V> mCollections;

    public VolarArrayMap() {
        super();
    }
     ...
     */
    public VolarArrayMap(int capacity) {
        super(capacity);
    }
     ...
     */
    public VolarArrayMap(VolarSimpleArrayMap map) {
        super(map);
    }
